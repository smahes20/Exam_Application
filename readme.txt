CS 342: Homework 4
Project part 4: Developing Applications Using Exam-Related Classes

*************************************************************************
Description: 

    Up until this point we have been developing a set of Exam-related classes, and testing them with a test
    driver, ExamTester. Now we are going to develop three related applications making use of the classes
    that have already been developed. We will also be introducing group work, and providing more leeway
    for groups to make design changes as needed. Each student will be responsible for providing and
    maintaining approximately 1/3 of the support classes ( Exam, SAQuestion, etc. ) and one of the
